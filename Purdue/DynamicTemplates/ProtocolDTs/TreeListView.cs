...
namespace TspdCfg.Purdue.DynTmplts
{
	...
	#region TreeListNode
	[DesignTimeVisible(false), TypeConverter("TspdCfg.Purdue.DynTmplts.TreeListNodeConverter")]
	...
	/// controls.
	/// </summary>
    public class TreeListView : TspdCfg.Purdue.DynTmplts.ContainerListView
	{
		#region Events
		...
		public TreeListView(): base()
		{
			...
			Assembly myAssembly = Assembly.GetAssembly(Type.GetType("TspdCfg.Purdue.DynTmplts.TreeListView"));
			Stream bitmapStream1 = myAssembly.GetManifestResourceStream("TspdCfg.Purdue.DynTmplts.tv_minus.bmp");
			bmpMinus = new Bitmap(bitmapStream1);

			Stream bitmapStream2 = myAssembly.GetManifestResourceStream("TspdCfg.Purdue.DynTmplts.tv_plus.bmp");
